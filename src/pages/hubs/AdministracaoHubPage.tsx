import { Database, List, GitCompare, ShieldCheck, Building2, Layers, Network, ShieldAlert } from "lucide-react";
...
const items: HubItem[] = [
  ...
  { to: "/modelos-matriz-riscos", label: "Modelos de Matriz de Riscos", description: "Cabeçalhos dos modelos padrão por segmento, modalidade e produto.", icon: ShieldAlert },
