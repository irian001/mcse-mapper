import { Database, List, GitCompare, ShieldCheck, Building2 } from "lucide-react";
...
const items: HubItem[] = [
  ...
  { to: "/mcse", label: "Estruturas de Auditoria", description: "Estruturas de referência por segmento (MCSE, COSIF, etc.).", icon: Database },
